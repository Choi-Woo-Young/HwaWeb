    ...
    <div data-scroll-to-active="true" class="main-menu menu-fixed menu-dark menu-accordion menu-shadow">
      ...
      <div class="main-menu-content">
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          <li class=" nav-item"><a href=""><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Dashboard</span><span class="tag tag tag-primary tag-pill float-xs-right mr-2">2</span></a> </li>
          <li class=" nav-item"><a href="<c:url value="/notices/noticeList"/> "><i class="icon-paper"></i><span data-i18n="nav.bootstrap_tables.table_basic" class="menu-title">공지사항</span></a>
          </li>
          <li class=" nav-item"><a href="<c:url value="/views/test"/> "><i class="icon-bell4"></i><span data-i18n="nav.bootstrap_tables.table_basic" class="menu-title">알림</span></a>
          </li>
            <li class=" nav-item"><a href="<c:url value="/views/test"/> "><i class="icon-alert-circled"></i><span data-i18n="nav.bootstrap_tables.table_basic" class="menu-title">이벤트/인시던트</span></a>
          </li>
            <li class=" nav-item"><a href="<c:url value="/views/test"/> "><i class="icon-volume-high"></i><span data-i18n="nav.bootstrap_tables.table_basic" class="menu-title">비상 위기 발령</span></a>
          </li>
            <li class=" nav-item"><a href="<c:url value="/views/test"/> "><i class="icon-ios-telephone-outline"></i><span data-i18n="nav.bootstrap_tables.table_basic" class="menu-title">비상연락망</span></a>
          </li>
