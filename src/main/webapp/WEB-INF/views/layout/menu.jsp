    ...
    <div data-scroll-to-active="true" class="main-menu menu-fixed menu-dark menu-accordion menu-shadow">
      ...
      <div class="main-menu-content">
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          ...
          <li class=" nav-item"><a href="<c:url value="/views/test"/> "><i class="icon-table2"></i><span data-i18n="nav.bootstrap_tables.table_basic" class="menu-title">알리미</span></a>
          </li>
            <li class=" nav-item"><a href="<c:url value="/views/test"/> "><i class="icon-table2"></i><span data-i18n="nav.bootstrap_tables.table_basic" class="menu-title">이벤트/인시던트</span></a>
          </li>
            <li class=" nav-item"><a href="<c:url value="/views/test"/> "><i class="icon-table2"></i><span data-i18n="nav.bootstrap_tables.table_basic" class="menu-title">비상 위기 발령</span></a>
          </li>
            <li class=" nav-item"><a href="<c:url value="/views/test"/> "><i class="icon-table2"></i><span data-i18n="nav.bootstrap_tables.table_basic" class="menu-title">비상연락망</span></a>
          </li>
