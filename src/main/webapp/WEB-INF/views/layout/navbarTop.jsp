      ...
      <div class="navbar-wrapper">
        <div class="navbar-header">
          <ul class="nav navbar-nav">
            ...
            <li class="nav-item"><a href="<c:url value="/"/>" class="navbar-brand nav-link"><img alt="branding logo" src="<c:url value="/resources/app-assets/images/logo/nice_alrimi-logo-light.png" />" data-expand="<c:url value="/resources/app-assets/images/logo/nice_alrimi-logo-light.png"/>" data-collapse="<c:url value="/resources/app-assets/images/logo/nice_alrimi-logo-light.png" />" class="brand-logo"></a></li>
