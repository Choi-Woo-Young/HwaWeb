...
<html lang="en" data-textdirection="ltr" class="loading">
  <head>
    ...
    <link rel="apple-touch-icon" sizes="60x60" href="<c:url value="/resources/app-assets/images/ico/apple-icon-60.png" />">
    <link rel="apple-touch-icon" sizes="76x76" href="<c:url value="/resources/app-assets/images/ico/apple-icon-76.png" />">
    <link rel="apple-touch-icon" sizes="120x120" href="<c:url value="/resources/app-assets/images/ico/apple-icon-120.png" />">
    <link rel="apple-touch-icon" sizes="152x152" href="<c:url value="/resources/app-assets/images/ico/apple-icon-152.png" />">
    <link rel="shortcut icon" type="image/x-icon" href="<c:url value="/resources/app-assets/images/ico/favicon.ico" />">
    <link rel="shortcut icon" type="image/png" href="<c:url value="/resources/app-assets/images/ico/favicon-32.png" />">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-touch-fullscreen" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="default">
    <!-- BEGIN VENDOR CSS-->
    <link rel="stylesheet" type="text/css" href="<c:url value="/resources/app-assets/css/bootstrap.css" />">
    <!-- font icons-->
    <link rel="stylesheet" type="text/css" href="<c:url value="/resources/app-assets/fonts/icomoon.css" />">
    <link rel="stylesheet" type="text/css" href="<c:url value="/resources/app-assets/fonts/flag-icon-css/css/flag-icon.min.css" />">
    <link rel="stylesheet" type="text/css" href="<c:url value="/resources/app-assets/vendors/css/extensions/pace.css" />">
    <!-- END VENDOR CSS-->
    <!-- BEGIN ROBUST CSS-->
    <link rel="stylesheet" type="text/css" href="<c:url value="/resources/app-assets/css/bootstrap-extended.css" />">
    <link rel="stylesheet" type="text/css" href="<c:url value="/resources/app-assets/css/app.css" />">
    <link rel="stylesheet" type="text/css" href="<c:url value="/resources/app-assets/css/colors.css" />">
    <!-- END ROBUST CSS-->
    <!-- BEGIN Page Level CSS-->
    <link rel="stylesheet" type="text/css" href="<c:url value="/resources/app-assets/css/core/menu/menu-types/vertical-menu.css" />">
    <link rel="stylesheet" type="text/css" href="<c:url value="/resources/app-assets/css/core/menu/menu-types/vertical-overlay-menu.css" />">
    <link rel="stylesheet" type="text/css" href="<c:url value="/resources/app-assets/css/core/colors/palette-gradient.css" />">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
      ...
      <div class="navbar-wrapper">
        <div class="navbar-header">
          <ul class="nav navbar-nav">
            ...
            <li class="nav-item"><a href="index.html" class="navbar-brand nav-link"><img alt="branding logo" src="<c:url value="/resources/app-assets/images/logo/robust-logo-light.png" />" data-expand="<c:url value="/resources/app-assets/images/logo/robust-logo-light.png"/>" data-collapse="<c:url value="/resources/app-assets/images/logo/robust-logo-small.png" />" class="brand-logo"></a></li>
            ...
            <ul class="nav navbar-nav float-xs-right">
              ...
              <li class="dropdown dropdown-notification nav-item"><a href="#" data-toggle="dropdown" class="nav-link nav-link-label"><i class="ficon icon-mail6"></i><span class="tag tag-pill tag-default tag-info tag-default tag-up">8</span></a>
                <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                  ...
                  <li class="list-group scrollable-container"><a href="javascript:void(0)" class="list-group-item">
                      <div class="media">
                        <div class="media-left"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="<c:url value="/resources/app-assets/images/portrait/small/avatar-s-1.png" />" alt="avatar"><i></i></span></div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left"><span class="avatar avatar-sm avatar-busy rounded-circle"><img src="<c:url value="/resources/app-assets/images/portrait/small/avatar-s-2.png" />" alt="avatar"><i></i></span></div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="<c:url value="/resources/app-assets/images/portrait/small/avatar-s-3.png" />" alt="avatar"><i></i></span></div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left"><span class="avatar avatar-sm avatar-away rounded-circle"><img src="<c:url value="/resources/app-assets/images/portrait/small/avatar-s-6.png" />" alt="avatar"><i></i></span></div>
                        <div class="media-body">
              ...
              <li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img src="<c:url value="/resources/app-assets/images/portrait/small/avatar-s-1.png" />" alt="avatar"><i></i></span><span class="user-name">John Doe</span></a>
...
<div class="row match-height">
    <div class="col-xl-4 col-md-6 col-sm-12">
        <div class="card" style="height: 440px;">
            <div class="card-body">
                <img class="card-img-top img-fluid" src="<c:url value="/resources/app-assets/images/carousel/05.jpg" />" alt="Card image cap">
                <div class="card-block">
                ...
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item">
                            <img src="<c:url value="/resources/app-assets/images/carousel/02.jpg" />" alt="First slide">
                        </div>
                        <div class="carousel-item active">
                            <img src="<c:url value="/resources/app-assets/images/carousel/03.jpg" />" alt="Second slide">
                        </div>
                        <div class="carousel-item">
                            <img src="<c:url value="/resources/app-assets/images/carousel/01.jpg" />" alt="Third slide">
                        </div>
                    </div>
    ...
    <!-- BEGIN VENDOR JS-->
    <script src="<c:url value="/resources/app-assets/js/core/libraries/jquery.min.js" />" type="text/javascript"></script>
    <script src="<c:url value="/resources/app-assets/vendors/js/ui/tether.min.js" />" type="text/javascript"></script>
    <script src="<c:url value="/resources/app-assets/js/core/libraries/bootstrap.min.js" />" type="text/javascript"></script>
    <script src="<c:url value="/resources/app-assets/vendors/js/ui/perfect-scrollbar.jquery.min.js" />" type="text/javascript"></script>
    <script src="<c:url value="/resources/app-assets/vendors/js/ui/unison.min.js" />" type="text/javascript"></script>
    <script src="<c:url value="/resources/app-assets/vendors/js/ui/blockUI.min.js" />" type="text/javascript"></script>
    <script src="<c:url value="/resources/app-assets/vendors/js/ui/jquery.matchHeight-min.js" />" type="text/javascript"></script>
    <script src="<c:url value="/resources/app-assets/vendors/js/ui/screenfull.min.js" />" type="text/javascript"></script>
    <script src="<c:url value="/resources/app-assets/vendors/js/extensions/pace.min.js" />" type="text/javascript"></script>
    <!-- BEGIN VENDOR JS-->
    <!-- BEGIN PAGE VENDOR JS-->
    <script src="<c:url value="/resources/app-assets/vendors/js/charts/chart.min.js" />" type="text/javascript"></script>
    <!-- END PAGE VENDOR JS-->
    <!-- BEGIN ROBUST JS-->
    <script src="<c:url value="/resources/app-assets/js/core/app-menu.js" />" type="text/javascript"></script>
    <script src="<c:url value="/resources/app-assets/js/core/app.js" />" type="text/javascript"></script>
    <!-- END ROBUST JS-->
    <!-- BEGIN PAGE LEVEL JS-->
    <script src="<c:url value="/resources/app-assets/js/scripts/pages/dashboard-lite.js" />" type="text/javascript"></script>
    <!-- END PAGE LEVEL JS-->
  </body>
</html>
